...
const enumSchema = { enum: [42, "foo"] } as const;
...
const arraySchema1 = { type: "array" } as const;
...
const objectSchema1 = { type: "object" } as const;
...
export type AssertObject2 = Assert<
  Equal<
    Object2,
    {
      a: Value;
...
export type AssertObject3 = Assert<
  Equal<
    Object3,
    {
      a?: number;
...
export type AssertObject4 = Assert<
  Equal<
    Object4,
    {
      a?: number;
...
export type AssertObject5 = Assert<
  Equal<
    Object5,
    {
      [K in string]?: Value;
...
export type AssertObject7 = Assert<
  Equal<
    Object7,
    {
      [K in string]?: string;
...
export type AssertObject8 = Assert<
  Equal<
    Object8,
    {
      a?: number;
...
export type AssertOneOf = Assert<
  Equal<
    TypeOfSchema<typeof oneOfSchema>,
    | {
        a: number;
      }
    | {
...
export type AssertAllOf = Assert<
  Equal<
    TypeOfSchema<typeof allOfSchema>,
    {
      a: number;
    } & {
      b: string;
